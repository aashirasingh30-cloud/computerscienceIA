...
# With Graphs + Data Science Visualizations
# ============================================
...
selected_currency = tk.StringVar(root, value="USD ($)")
...
def create_card(parent, title, color):
    frame = tk.Frame(parent, bg="white", width=250, height=120)
...
currency_menu.pack(side="right", padx=20)
currency_menu.bind("<<ComboboxSelected>>", lambda e: update_summary())

# ---------------------------
# DASHBOARD TITLE
# ---------------------------
title_frame = tk.Frame(root, bg="#f3f4f6")
...
# CARDS
# ---------------------------
cards_frame = tk.Frame(root, bg="#f3f4f6")
...
# INPUT SECTION
# ---------------------------
input_container = tk.Frame(root, bg="#f3f4f6")
...
income_entry.grid(row=1, column=0, pady=10)
...
expense_amount_entry.grid(row=4, column=0, pady=5)
...
expense_category_entry.grid(row=6, column=0, pady=5)
...
styled_button(
    ...
    "Add Expense",
    add_expense
).grid(row=4, column=1, rowspan=3, padx=15)

# ---------------------------
# CHARTS SECTION
# ---------------------------
charts_frame = tk.Frame(root, bg="#f3f4f6")
...
def update_charts():
    ...
    if expenses:
        ...
        sample_categories = ["Bills", "Food", "Shopping", "Transport"]
        sample_values = [40, 25, 20, 15]
...
# QUICK ACTIONS
# ---------------------------
quick_frame = tk.Frame(root, bg="#f3f4f6")
...
actions = tk.Frame(quick_card, bg="white")
actions.pack()
